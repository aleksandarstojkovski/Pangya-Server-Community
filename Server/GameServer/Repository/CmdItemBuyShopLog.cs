...
namespace Pangya_GameServer.Repository
{
    public class CmdItemBuyShopLog : Pangya_DB
    {
        ...
        protected override Response prepareConsulta()
        {
            ...
            var r = procedure(
                m_szConsulta, Convert.ToString(m_uid) + ", " + Convert.ToString(m_buy_shop._typeid) + ", " + Convert.ToString(m_buy_shop.id) + ", " + Convert.ToString(m_buy_shop.time) + ", " + Convert.ToString(m_buy_shop.ItemType) + ", " + Convert.ToString(m_buy_shop.qntd) + ", " + Convert.ToString(m_buy_shop.pang) + ", " + Convert.ToString(m_buy_shop.cookie));
