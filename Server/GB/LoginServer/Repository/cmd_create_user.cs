...
namespace LoginServer.Repository
{
    public class CmdCreateUser : Pangya_DB
    {
        ...
        { 
            ...
            //versao padrao usa US para criar usuario, entao mantem como padrao, no US, vem em MD5 hash....
            r = procedure(m_szConsulta, makeText(m_id) + ", " + makeText(m_pass) + ", " + makeText("0") /*sex*/ + ", " + makeText(m_ip) + ", " + makeText(m_server_uid));
        ...
        private string m_szConsulta = "pangya.ProcNewUserWithMD5";
    }
}
