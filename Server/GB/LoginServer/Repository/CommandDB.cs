...
namespace LoginServer.DataBase
{
    public class CommandDB : PangyaCommandDB
    {
        ...
        //  🔹 CREATE USER
        // ============================================================
        public static bool CreateBetaUser(uint _uid, string id, string pass, string ip, uint serverUid)
        {
            var cmd = new CmdCreateUserBeta(_uid, id, pass, ip, serverUid);
            ...
            return true;    // Command já executa no construtor
        }
        // ============================================================
        //  🔹 CREATE USER
        // ============================================================
