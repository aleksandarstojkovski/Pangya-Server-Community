        ...
        public static PangyaBinaryWriter pacote001(Player _session, byte option = 0, int sub_opt = 0)
        {
            ...
            switch (option)
            {
                case 0:
                    ...
                    p.WriteInt32(_session.m_pi.level);            // 1 level, 1 pc bang(ACHO), com base no S4
                    p.WriteInt32(10);                              // valor 0 Unknown
                    p.WriteUInt16(12);                             // Unknown valor - JP S9 ler mais ignora ele
