...
namespace Pangya_GameServer.UTIL
{
    public class Lottery
    {
        ...
        public void Push(uint prob, object value, uint typeid = 0)
        {
            ...
            m_roletaValid = false;//bota como falso, pois ele precisa reepreencher dados
        }
        ...
        public void FillRoleta()
        {
            ...
            {
                double weight = el.Prob > 0 ? el.Prob : 1; // nunca zero
                el.Offset[0] = (ulong)probLimit;
                el.Offset[1] = (ulong)(probLimit + weight - 1);
                probLimit += weight;
                m_roleta.Add(el);
            }

            m_probLimit = (ulong)probLimit;
            m_roletaValid = true;//ficou errado, devido um pequeno codigo
        }
        ...
        public LotteryCtx SpinRoleta(bool removeItemDraw = false)
        {
            ...
            ulong lucky = (ulong)rand.Next(minValue: 0, (int)m_probLimit);
