...
namespace Pangya_GameServer.GameServerTcp
{
    public class GameServer : Server
    {
        ...
        {// Reseta PCBangMascot antes de atualizar ela 
        ...
        public void destroyRoom(byte _channel_owner, short _number)
        {
            ...
            {
                _smp.message_pool.getInstance().push(new message("[GameServer::destroyRoom][ErrorSystem] " + e.getFullMessageError(), type_msg.CL_FILE_LOG_AND_CONSOLE));
            }
        }
        ...
        public void sendUpdateRoomInfo(Room _r, int _option)
        {
            try
            {
                ...
                if (_r != null)
                {
                    ...
                    if (c != null)
                        c.sendUpdateRoomInfo(_ri: _r.getInfo(), _option);
                }
            ...
            catch (exception e)
            {
                ...
                _smp.message_pool.getInstance().push(new message("[GameServer::sendUpdateRoomInfo][ErrorSystem] " + e.getFullMessageError(), type_msg.CL_FILE_LOG_AND_CONSOLE));
            }
        }
            ...
            try
            {
                ...
                if (s != null)
                {
                    ...
                    else
                    {
                        ...
                        // Só desconecta aqui se a PCBangMascot do server de poder logar com o mesmo id estiver desativada
                        if (!(same_id_login == 1))
                            DisconnectSession(s);
                    }
        ...
        public override bool CheckCommand(Queue<string> _command)
        {
            ...
            else if (s == "broadcast_tst")
            {
                ...
                string rewardStr = "{" + string.Join(", ", reward.ConvertAll(r => $"[{r.ToString()}]")) + "}";

                _smp.message_pool.getInstance().push(new message(
                    $"[GameServer::CheckCommand][Info] Bot GM Event Broadcast teste, criando a sala agora, o jogo comeca em {durationEventInterval} minutos. Reward({reward.Count}){rewardStr}", type_msg.CL_FILE_LOG_AND_CONSOLE));
            ...
            else if (s == "msg_gz")
            {
                ...
                _smp.message_pool.getInstance().push(new message($"[GameServer::CheckCommand][Error] Broadcast Msg ID={optBroadcast}", type_msg.CL_FILE_LOG_AND_CONSOLE));
        ...
        [Obsolete]
        public void init_Packets()
        {
            _smp.message_pool.getInstance().push(new message("[GameServer::init_Packets][Log] Init Add Packet Game!", type_msg.CL_FILE_LOG_AND_CONSOLE));

            // ============================
            // Client -> Server (funcs)
            // ============================
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQUEST_LOGIN, packet_func.packet002, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_CHAT, packet_func.packet003, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_ENTER_CHANNEL, packet_func.packet004, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_MY_STATISTICS, packet_func.packet006, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQUEST_USERINFO_OFFLINE, packet_func.packet007, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQUEST_CREATE_ROOM, packet_func.packet008, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQUEST_JOIN_ROOM, packet_func.packet009, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQUEST_ROOMINFO_CHANGED, packet_func.packet00A, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_LOBBY_USERINFO_CHANGED, packet_func.packet00B, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQUEST_USERINFO_CHANGED, packet_func.packet00C, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_SET_PLAYER_READY, packet_func.packet00D, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQUEST_START_GAME, packet_func.packet00E, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_EXIT_ROOM, packet_func.packet00F, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQUEST_CHANGE_TEAM, packet_func.packet010, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_LOAD_OK, packet_func.packet011, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_SHOT, packet_func.packet012, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_CAMERA, packet_func.packet013, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_CLICK, packet_func.packet014, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_POWER_SHOT, packet_func.packet015, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_CLUB, packet_func.packet016, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_USE_ITEM, packet_func.packet017, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_EMOTICON, packet_func.packet018, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_DROP, packet_func.packet019, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_HOLE_INFO, packet_func.packet01A, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_SHOT_RESULT, packet_func.packet01B, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_SHOT_ACK, packet_func.packet01C, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQUEST_BUY_ITEM, packet_func.packet01D, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQUEST_GIFT_ITEM, packet_func.packet01F, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQUEST_EQUIP_ITEM, packet_func.packet020, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_TIMECHECK, packet_func.packet022, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQUEST_BANISH, packet_func.packet026, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_INVITE, packet_func.packet029, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_WHISPER, packet_func.packet02A, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQUEST_DETAIL_ROOM_INFO, packet_func.packet02D, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQUEST_USERINFO, packet_func.packet02F, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_PAUSE, packet_func.packet030, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_HOLE_STAT, packet_func.packet031, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_SLEEP, packet_func.packet032, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REPORT_ERROR, packet_func.packet033, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_TEESHOT_READY, packet_func.packet034, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_TEAM_HOLEIN_PANG, packet_func.packet035, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_ANSWER_GOSTOP, packet_func.packet036, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_END_STROKE_GAME, packet_func.packet037, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REEMPLOY_CADDIE, packet_func.packet039, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REPORT, packet_func.packet03A, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_MSN_REQUEST, packet_func.packet03C, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQUEST_CASH, packet_func.packet03D, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_JOIN_GALLERY, packet_func.packet03E, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQUEST_IDENTITY, packet_func.packet041, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_SHOT_COMMAND, packet_func.packet042, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQUEST_SERVER_LIST, packet_func.packet043, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQUEST_RANKADDRESS, packet_func.packet047, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_LOADING_INFO, packet_func.packet048, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REPLAY_ONLINE, packet_func.packet04A, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_ENCHANT, packet_func.packet04B, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_CHAT_PENALITY, packet_func.packet04F, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_TEAMCHAT, packet_func.packet054, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_ALLOW_WHISPER, packet_func.packet055, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_NOTICE, packet_func.packet057, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQUEST_SERVER_TIME, packet_func.packet05C, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_DESTROY_ROOM, packet_func.packet060, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQUEST_KICK, packet_func.packet061, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_SYNC_ACTIVITY, packet_func.packet063, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_DELETE_ITEM, packet_func.packet064, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_SPEED_RATE, packet_func.packet065, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_ONELINE_REQUEST, packet_func.packet066, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_ONELINE_QUERY, packet_func.packet067, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_UPDATE_GAME_OPTIONI, packet_func.packet069, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_CHECK_CADDIE_WARNNING, packet_func.packet06B, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_CHANGE_MASCOT, packet_func.packet073, this);

            //----------------------TRADE/PERSONAL SHOP --------------------------//               
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_TRADE_OPEN_SHOP, packet_func.packet074, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_TRADE_CLOSE_SHOP, packet_func.packet075, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_TRADE_EDIT_SHOP, packet_func.packet076, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_TRADE_ENTER_SHOP, packet_func.packet077, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_TRADE_EXIT_SHOP, packet_func.packet078, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_TRADE_EDIT_TITLE, packet_func.packet079, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_TRADE_SHOW_VISITOR, packet_func.packet07A, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_TRADE_INCOME, packet_func.packet07B, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_TRADE_EDIT_ITEM, packet_func.packet07C, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_TRADE_BUY_ITEM, packet_func.packet07D, this);
            //----------------------END --------------------------//

            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_ENTER_LOBBY, packet_func.packet081, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_LEAVE_LOBBY, packet_func.packet082, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_MOVE_LOBBY_TO_LOBBY, packet_func.packet083, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_RESPONSE_GGCSAUTH, packet_func.packet088, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQUEST_MESSENGER_SERVER_LIST, packet_func.packet08B, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_GM_COMMAND, packet_func.packet08F, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQ_PLAYTIME_UPDATE, packet_func.packet098, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_UPDATE_PCBANG_MASCOTMSG, packet_func.packet09A, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_USER_MATCH_HISTORY, packet_func.packet09C, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_INTRUSION, packet_func.packet09D, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQUEST_REFRESH_GACHA_TICKETS, packet_func.packet09E, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_UPDATE_INGAME_WEBPAGE, packet_func.packet0A1, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQUEST_PANG_INFO, packet_func.packet0A2, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_USE_TIKI_REPORT, packet_func.packet0AA, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_OPEN_TIKI_REPORT, packet_func.packet0AB, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_COMPLETE_QUEST, packet_func.packet0AE, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_OPEN_LUCKY_POUCH, packet_func.packet0B2, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_DIRECTJOIN_ROOM, packet_func.packet0B4, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQUEST_CREATE_REALMYRROM, packet_func.packet0B5, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_RMR_OBJECTLOAD, packet_func.packet0B7, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_UCC_REQUEST, packet_func.packet0B9, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_CHECK_INVITE, packet_func.packet0BA, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_USE_CARD_REQUEST, packet_func.packet0BD, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQUEST_UPDATE_USER_PLACE, packet_func.packet0C1, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_SECURITY_KEY, packet_func.packet0C9, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_OPEN_CARDPACK, packet_func.packet0CA, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_CAN_APPROACH_READY, packet_func.packet0CB, this);
            
            //----------------------DOLFINE LOCKER --------------------------//         
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_ITEMSTORAGE_REQ_ACCESS, packet_func.packet0CC, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_ITEMSTORAGE_REQ_PAGE, packet_func.packet0CD, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_ITEMSTORAGE_REQ_PUSH, packet_func.packet0CE, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_ITEMSTORAGE_REQ_POP, packet_func.packet0CF, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_ITEMSTORAGE_SET_PASSWORD, packet_func.packet0D0, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_ITEMSTORAGE_REQ_CHANGE_PW, packet_func.packet0D1, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_ITEMSTORAGE_SET_LOCK, packet_func.packet0D2, this); 
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_ITEMSTORAGE_REQ_STATE, packet_func.packet0D3, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_ITEMSTORAGE_REQ_PANG_INOUT, packet_func.packet0D4, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_ITEMSTORAGE_REQ_PANG, packet_func.packet0D5, this);
            //----------------------END --------------------------//

            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_ITEM_BUFF, packet_func.packet0D8, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_WHISPEROFF_TASK, packet_func.packet0DE, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQ_CUTIN, packet_func.packet0E5, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQ_EXTEND_RENTAL, packet_func.packet0E6, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQ_DELETE_RENTAL, packet_func.packet0E7, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQ_CHARACTER_STAT_IN_CHATROOM, packet_func.packet0EB, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_SUPPLY_PACK_OPEN, packet_func.packet0EC, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQ_USE_NEW_RANDOMBOX, packet_func.packet0EF, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_HEARTBEAT, packet_func.packet0F4, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_WEB_AUTH_KEY, packet_func.packet0FB, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQ_ALL_UCC_FROM_ALL_PLAYER, packet_func.packet0FE, this);

            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQ_CHANGE_GAME_SERVER, packet_func.packet119, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQ_POINT_SHOP_OPEN, packet_func.packet126, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQ_POINT_SHOP_POINT, packet_func.packet127, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQ_POINT_SHOP_EXCHANGE_TP_BY_ITEM, packet_func.packet128, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQ_POINT_SHOP_EXCHANGE_ITEM_BY_TP, packet_func.packet129, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_CAN_GRANDZODIAC_READY, packet_func.packet12C, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_CAMERA_INITIAL_GRANDZODIAC, packet_func.packet12D, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_MARK_ON_COURSE, packet_func.packet12E, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_SHOT_END_LOCATION_DATA, packet_func.packet12F, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_LEAVE_PRACTICE, packet_func.packet130, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_LEAVE_CHIP_IN_PRACTICE, packet_func.packet131, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_START_FIRST_HOLE_GRANDZODIAC, packet_func.packet137, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_ACTIVE_WING_EFFECT, packet_func.packet138, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQ_ENTER_SHOP, packet_func.packet140, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQ_CHANGE_WIND_NEXT_HOLE_REPEAT, packet_func.packet141, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQ_NEW_MAILBOX_OPEN_MAILBOX, packet_func.packet143, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQ_NEW_MAILBOX_OPEN_MAIL, packet_func.packet144, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQ_NEW_MAILBOX_SEND_MAIL, packet_func.packet145, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQ_NEW_MAILBOX_MOVE_ITEM_TO_MYROOM, packet_func.packet146, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQ_NEW_MAILBOX_DELETE_MAIL, packet_func.packet147, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQ_NEW_BONGDARISHOP_PLAY_NORMAL, packet_func.packet14B, this);

            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQ_DAILYQUEST_OPEN, packet_func.packet151, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQ_DAILYQUEST_AGREE, packet_func.packet152, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQ_DAILYQUEST_GET_REWARD, packet_func.packet153, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQ_DAILYQUEST_FORFEIT, packet_func.packet154, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQ_LOLO_CARD_COMPOSE, packet_func.packet155, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_ACTIVE_AUTO_COMMAND, packet_func.packet156, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQ_ACHIEVEMENT_OPEN, packet_func.packet157, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_REQ_CADIE_MAGICBOX_EXCHANGE_ITEM, packet_func.packet158, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_ACTIVE_PAWS_EFFECT, packet_func.packet15C, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_ACTIVE_RING_EFFECT, packet_func.packet15D, this);

            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_CLUBSETWORKSHOP_REQ_UP_LEVEL, packet_func.packet164, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_CLUBSETWORKSHOP_CONFIRM_UP_LEVEL, packet_func.packet165, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_CLUBSETWORKSHOP_CANCEL_UP_LEVEL, packet_func.packet166, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_CLUBSETWORKSHOP_REQ_UP_RANK, packet_func.packet167, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_CLUBSETWORKSHOP_CONFIRM_UP_RANK_TRANSFORM, packet_func.packet168, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_CLUBSETWORKSHOP_CANCEL_UP_RANK_TRANSFORM, packet_func.packet169, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_CLUBSETWORKSHOP_REQ_RECOVERY_POINT, packet_func.packet16B, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_CLUBSETWORKSHOP_REQ_TRANSFER_MASTERY_POINT, packet_func.packet16C, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_CLUBSETWORKSHOP_REQ_RESET_CLUBSET, packet_func.packet16D, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_ATTENDENCE_REWARD_OPEN, packet_func.packet16E, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_ATTENDENCE_REWARD_CHECK_DAY, packet_func.packet16F, this);

            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_ACTIVE_EARCUFF_EFFECT, packet_func.packet171, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_WORKSHOP_EVENT_2013_OPEN, packet_func.packet172, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_WORKSHOP_EVENT_UN_173, packet_func.packet173, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_WORKSHOP_EVENT_UNK_174, packet_func.packet174, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_WORKSHOP_EVENT_UNK_173, packet_func.packet175, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_GRANDPRIX_REQ_ENTER_LOBBY, packet_func.packet176, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_GRANDPRIX_REQ_LEAVE_LOBBY, packet_func.packet177, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_GRANDPRIX_REQ_ENTER_ROOM, packet_func.packet179, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_GRANDPRIX_REQ_LEAVE_ROOM, packet_func.packet17A, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_MEMORIALSHOP_PLAY, packet_func.packet17F, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_ACTIVE_GLOVE_EFFECT, packet_func.packet180, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_ACTIVE_RING_GROUND_EFFECT, packet_func.packet181, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_TOGGLE_ASSIST, packet_func.packet184, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_ACTIVE_ASSIST_GREEN, packet_func.packet185, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_MEMORIALSHOP_PLAY_BIG, packet_func.packet186, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_CHARACTER_STATS_EXPAND_MASTERY, packet_func.packet187, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_CHARACTER_STATS_UPGRADE_STAT, packet_func.packet188, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_CHARACTER_STATS_DOWNGRADE_STAT, packet_func.packet189, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_CHARACTER_STATS_EQUIP_CARD, packet_func.packet18A, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_CHARACTER_STATS_EQUIP_CARD_WITH_CLUB_PATCHER, packet_func.packet18B, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_CHARACTER_STATS_REMOVE_CARD, packet_func.packet18C, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_NEW_TIKISHOP_EXCHANGE_ITEM, packet_func.packet18D, this);

            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_ARIN_EVENT_2014_OPEN, packet_func.packet192, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_ACTIVE_RING_PAWS_RAINBOW_EFFECT, packet_func.packet196, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_ACTIVE_RING_POWER_GAUGE_EFFECT, packet_func.packet197, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_ACTIVE_RING_MIRACLE_SIGN_EFFECT, packet_func.packet198, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_ACTIVE_RING_PAWS_RING_SET_EFFECT, packet_func.packet199, this);
                                                                                       
            //---------------------- GUILD SYSTEM --------------------------//
            packet_func.funcs.addPacketCall((ushort)PacketIDClient.CLIENT_NEW_GUILD_MNGR_CREATE, packet_func.packet0101, this);//faltei add esse aqui
            packet_func.funcs.addPacketCall((ushort)PacketIDClient.CLIENT_NEW_GUILD_MNGR_CHECK_NAME, packet_func.packet0102, this);//faltei add esse aqui
            packet_func.funcs.addPacketCall((ushort)PacketIDClient.CLIENT_NEW_GUILD_MNGR_CHANGE_NAME, packet_func.packet0103, this);//faltei add esse aqui
            packet_func.funcs.addPacketCall((ushort)PacketIDClient.CLIENT_NEW_GUILD_MNGR_REQ_PAGE, packet_func.packet0108, this);
            packet_func.funcs.addPacketCall((ushort)PacketIDClient.CLIENT_NEW_GUILD_MNGR_SEARCH, packet_func.packet0109, this);
            packet_func.funcs.addPacketCall((ushort)PacketIDClient.CLIENT_NEW_GUILD_MNGR_PLAYER_PAST_ACTIVITIES, packet_func.packet010A, this);
            packet_func.funcs.addPacketCall((ushort)PacketIDClient.CLIENT_NEW_GUILD_MNGR_INFO, packet_func.packet0104, this);
            packet_func.funcs.addPacketCall((ushort)PacketIDClient.CLIENT_NEW_GUILD_MNGR_MEMBER_INFO, packet_func.packet0112, this);
            packet_func.funcs.addPacketCall((ushort)PacketIDClient.CLIENT_NEW_GUILD_MNGR_MEMBER_PROMOTE, packet_func.packet0101, this);
            packet_func.funcs.addPacketCall((ushort)PacketIDClient.CLIENT_NEW_GUILD_MNGR_CHANGE_INFO_MSG, packet_func.packet0106, this);
            packet_func.funcs.addPacketCall((ushort)PacketIDClient.CLIENT_NEW_GUILD_MNGR_CHANGE_NOTICE_MSG, packet_func.packet0105, this);
            packet_func.funcs.addPacketCall((ushort)PacketIDClient.CLIENT_NEW_GUILD_MNGR_MEMBER_JOIN, packet_func.packet010C, this);
            packet_func.funcs.addPacketCall((ushort)PacketIDClient.CLIENT_NEW_GUILD_MNGR_MEMBER_AGREE, packet_func.packet010E, this);
            packet_func.funcs.addPacketCall((ushort)PacketIDClient.CLIENT_NEW_GUILD_MNGR_MEMBER_KICK, packet_func.packet0114, this);
            packet_func.funcs.addPacketCall((ushort)PacketIDClient.CLIENT_NEW_GUILD_MNGR_MEMBER_CHANGE_MSG, packet_func.packet0111, this);
            packet_func.funcs.addPacketCall((ushort)PacketIDClient.CLIENT_NEW_GUILD_MNGR_EMBLEM_CHANGE, packet_func.packet0115, this);
            packet_func.funcs.addPacketCall((ushort)PacketIDClient.CLIENT_NEW_GUILD_MNGR_EMBLEM_CHANGE_CONFIRM, packet_func.packet0116, this);
            packet_func.funcs.addPacketCall((ushort)PacketIDClient.CLIENT_NEW_GUILD_MNGR_MEMBER_JOIN_CANCEL, packet_func.packet010D, this);
            //----------------------END --------------------------//

            //----------------------SCRATCH CARD--------------------------//    
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_OPENUP_SCRATCHCARD, packet_func.packet1EB, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_PLAY_SCRATCHCARD, packet_func.packet00DD, this);
            packet_func.funcs.addPacketCall(tipo: (ushort)PacketIDClient.CLIENT_ENTER_SCRATCHY_SERIAL, packet_func.packet00DE, this);
            //----------------------END --------------------------//
            ...
            packet_func.funcs_sv.addPacketCall((ushort)PacketIDServer.SERVER_LOGIN_ACK, packet_func.packet_svFazNada, this);
            ...
            packet_func.funcs_sv.addPacketCall(0x050, packet_func.packet_svFazNada, this);
            ...
            packet_func.funcs_sv.addPacketCall(0xD5, packet_func.packet_svFazNada, this);
            packet_func.funcs_sv.addPacketCall(0xD6, packet_func.packet_svFazNada, this);
            packet_func.funcs_sv.addPacketCall(0xD7, packet_func.packet_svFazNada, this);   // Request GameGuard Auth
            packet_func.funcs_sv.addPacketCall(0xDD, packet_func.packet_svFazNada, this);
            packet_func.funcs_sv.addPacketCall(0xDE, packet_func.packet_svFazNada, this);
            ...
            packet_func.funcs_sv.addPacketCall(0x108, packet_func.packet_svFazNada, this);
            ...
            packet_func.funcs_sv.addPacketCall(0x1EB, packet_func.packet_svFazNada, this);// resposta d scratch card 
            ...
            packet_func.funcs_sv.addPacketCall(0x1B8, packet_func.packet_svFazNada, this);
            packet_func.funcs_sv.addPacketCall(0x1BC, packet_func.packet_svFazNada, this);
            packet_func.funcs_sv.addPacketCall(0x1BD, packet_func.packet_svFazNada, this);
            packet_func.funcs_sv.addPacketCall(0x1BE, packet_func.packet_svFazNada, this);
            packet_func.funcs_sv.addPacketCall(0x1C6, packet_func.packet_svFazNada, this);
            packet_func.funcs_sv.addPacketCall(0x1C5, packet_func.packet_svFazNada, this);
            packet_func.funcs_sv.addPacketCall(0x1C4, packet_func.packet_svFazNada, this);
            packet_func.funcs_sv.addPacketCall(0x1C0, packet_func.packet_svFazNada, this);//0x1BF
            packet_func.funcs_sv.addPacketCall(0x1C1, packet_func.packet_svFazNada, this);//0x1BF
            packet_func.funcs_sv.addPacketCall(0x1BF, packet_func.packet_svFazNada, this);//0x1BF
            packet_func.funcs_sv.addPacketCall(0x1C2, packet_func.packet_svFazNada, this);//0x1BF
            packet_func.funcs_sv.addPacketCall(0x1D1, packet_func.packet_svFazNada, this);//0x1BF
            packet_func.funcs_sv.addPacketCall(0x1B9, packet_func.packet_svFazNada, this);
            packet_func.funcs_sv.addPacketCall(0x1BA, packet_func.packet_svFazNada, this);
            packet_func.funcs_sv.addPacketCall(0x1C9, packet_func.packet_svFazNada, this);//0x1BF
            packet_func.funcs_sv.addPacketCall(0x1C8, packet_func.packet_svFazNada, this);
            packet_func.funcs_sv.addPacketCall(0x1CA, packet_func.packet_svFazNada, this);
            packet_func.funcs_sv.addPacketCall(0x1B6, packet_func.packet_svFazNada, this);
            packet_func.funcs_sv.addPacketCall(0x1B7, packet_func.packet_svFazNada, this);
            //faltou add
            packet_func.funcs_sv.addPacketCall(0x1B5, packet_func.packet_svFazNada, this);
            packet_func.funcs_sv.addPacketCall(0x0C5, packet_func.packet_svFazNada, this);
            // Auth Server Comandos
            packet_func.funcs_as.addPacketCall(0x1, packet_func.packet_as001, this);

            _smp.message_pool.getInstance().push(new message("[GameServer::init_Packets][Log] Finish Add Packet Game!", type_msg.CL_FILE_LOG_AND_CONSOLE));
        }
        ...
        public void init_load_channels()
        {
            ...
            try
            {
                ...
                for (byte i = 0; i < num_channel; ++i)
                {
                    ...
                    {
                        _smp.message_pool.getInstance().push(new message("[GameServer::init_load_channels][ErrorSystem] " + e.getFullMessageError(), type_msg.CL_FILE_LOG_AND_CONSOLE));
                    }
            ...
            v_channel = v_channel.OrderBy(c => c.getInfo().flag.ulFlag).ToList();
        }
        ...
        public void reloadGlobalSystem(uint _tipo)
        {
            try
            {
                ...
                _smp.message_pool.getInstance().push(
                     new message($"[GameServer::reloadGlobalSystem][Error] Recarregou o Sistema[Tipo={_tipo}] com sucesso!", type_msg.CL_FILE_LOG_AND_CONSOLE)
                 );
            }
            catch (Exception e)
            {
        ...
        public void makeGrandZodiacEventRoom()
        {
            ...
            try
            {
                ...
                var rt = sGrandZodiacEvent.getInstance().getInterval();
                ...
                if (rt.m_room_created)
                {
                    return;
                }

                // Verifica se já enviou a mensagem, se não envia ela
                if (rt != null && !rt.m_sended_message)//aqui so deve ser enviado quando tiver jogadores
                {
                    ...
                    const string MESSAGE_ZODIAC_EVENT_START_PART1 = "<PARAMS><RunningTime>";
                    const string MESSAGE_ZODIAC_EVENT_START_PART2 = "</RunningTime><BroadCastReservedNoticesIdx>531</BroadCastReservedNoticesIdx></PARAMS>";

                    var duration_event_interval = rt.getDiffInterval() / (1000 * 60); // Minutos

                    // Arredonda para o próximo multiplo de 10, se a diferença for de 1min
                    var resto = duration_event_interval % 10;
                    ...
                    // Log
                    _smp.message_pool.getInstance().push(new message("[GameServer::makeGrandZodiacEventRom][Error] Grand Zodiac Event comecou, vai ficar ativo por " + Convert.ToString(duration_event_interval) + "min.", type_msg.CL_FILE_LOG_AND_CONSOLE));

                    string msg = MESSAGE_ZODIAC_EVENT_START_PART1 + Convert.ToString(duration_event_interval) + MESSAGE_ZODIAC_EVENT_START_PART2;

                    var p = new PangyaBinaryWriter(0x1D3);

                    p.WriteUInt32(2); // Count

                    for (var i = 0u; i < 2; ++i)
                    {

                        p.WriteUInt32(eBROADCAST_TYPES.BT_GRAND_ZODIAC_EVENT_START_TIME); // Type Grand Zodiac Event
                        p.WriteString(msg);
                    }
                ...
                {
                    _smp.message_pool.getInstance().push(new message("[GameServer::makeGrandZodiacEventRoom][Warning] Entrou no makeGrandZodiacEventRoom, mas nao tem nenhum range_time(interval) que o Grand Zodiac Event esta ativado.", type_msg.CL_FILE_LOG_AND_CONSOLE));
                }
            ...
            catch (exception e)
            {
                ...
                _smp.message_pool.getInstance().push(new message("[GameServer::makeGrandZodiacEventRoom][ErrorSystem] " + e.getFullMessageError(), type_msg.CL_FILE_LOG_AND_CONSOLE));
            }
        }
        ...
        public void makeListOfPlayersToGoldenTime()
        {
            ...
            try
            {
                ...
                if (current_round == null)
                {
                    ...
                    // Log
                    _smp.message_pool.getInstance().push(new message("[GameServer::makeListOfPlayersToGoldenTime][Error] current_round(nullptr) is invalid", type_msg.CL_FILE_LOG_AND_CONSOLE));
                ...
                if (players.Count == 0)
                {
                    ...
                    // Log
                    _smp.message_pool.getInstance().push(new message("[GameServer::makeListOfPlayersToGoldenTime][Error] Nenhum player ganhou no Golden Time Event. Round(" + UtilTime.FormatDate(current_round.time) + ")", type_msg.CL_FILE_LOG_AND_CONSOLE));
                ...
                else
                {
                    ...
                    // Log
                    _smp.message_pool.getInstance().push(new message("[GameServer::makeListOfPlayersToGoldenTime][Error] Winners Of Round[" + UtilTime.FormatDate(current_round.time) + "] ITEM[TYPEID=" + Convert.ToString(current_round.item._typeid) + ", QNTD=" + Convert.ToString(current_round.item.qntd) + ", QNTD_TIME=" + Convert.ToString(current_round.item.qntd_time) + "] Player(s)[" + printAllPlayerUID(reward.players) + "]", type_msg.CL_FILE_LOG_AND_CONSOLE));
            ...
            {
                _smp.message_pool.getInstance().push(new message("[GameServer::makeListOfPlayersToGoldenTime][ErrorSystem] " + e.getFullMessageError(), type_msg.CL_FILE_LOG_AND_CONSOLE));
            }
        }
        ...
        public void makeBotGMEventRoom()
        {
            ...
            try
            {
                ...
                // Se passou do tempo, não cria mais nada
                if (rt.isPastEnd(new SYSTEMTIME(DateTime.Now)))
                {
                    if (!rt.m_room_closed)
                    {
                        rt.m_room_closed = true;
                    }
            ...
            {
                _smp.message_pool.getInstance().push(new message(
                    "[GameServer::makeBotGMEventRoom][ErrorSystem] " + e.getFullMessageError(),
        ...
        public override bool CheckPacket(Session _session, packet packet, int opt = 0)
        {
            ...
            switch (opt)
            {
                case 1:
                    ...
                    {
                        _smp.message_pool.getInstance().push(new message($"[GameServer::CheckPacket][Info]: PLAYER[UID: {player.m_pi.uid}, CGPID: 0x{packet.Id:X}]", type_msg.CL_ONLY_CONSOLE));
                        return true;
                    }
                default:
        ...
        public void requestCommonCmdGM(Player _session, packet _packet)
        {
            ...
            {
                _smp.message_pool.getInstance().push(new message("[GameServer::requestCommonCmdGM][ErrorSystem] " + e.getFullMessageError(), type_msg.CL_FILE_LOG_AND_CONSOLE));
            }
        }
        ...
        public void requestLogin(Player session, packet pkt)
        {
            ...
            try
            {
                ...
                ReadLoginPacket(session, pkt, out uint ntreevUID, out ushort command,
                                ...
                                out packetVersion, out uint isPcBang, out kol.keys[1], out bool hasAuthKeyGame);

                bool hasAuthKeyLogin = !string.IsNullOrEmpty(kol.keys[0]);

                // --- Validações básicas do pacote e do cliente ---
                if (!ValidateLoginPacket(session, hasClientVersion, clientVersion, packetVersion, hasAuthKeyLogin, kol.keys[0], hasAuthKeyGame, kol.keys[1]))
                {
                    _smp.message_pool.getInstance().push(new message("[GameServer::requestLogin][Warning] PLAYER[UID=" + (session.m_pi.uid) + $", UserID= {session.m_pi.id}, AuthKey[1]= {kol.keys[0]},  AuthKey[2]= {kol.keys[1]}, NtreevUID= {ntreevUID}, CVersion= {clientVersion}]", type_msg.CL_FILE_LOG_AND_CONSOLE));
                ...
                // --- Ban checks (IP / MAC) ---
                if (this.haveBanList(session.getIP(), macAddress, false))
                ...
                {
                    _smp.message_pool.getInstance().push(new message(
                        $"[GameServer::requestLogin][Warning] PLAYER[UID={session.m_pi.uid}]. Client Packet Version not match. Server: {serverPacketVersion} != Client: {packetVersion}",
                        type_msg.CL_FILE_LOG_AND_CONSOLE));
                ...
                {
                    _smp.message_pool.getInstance().push(new message($"[GameServer::requestLogin][Warning] PLAYER[UID={session.m_pi.uid}]. LKey invalid or reused.", type_msg.CL_FILE_LOG_AND_CONSOLE));
                    session.m_is_authorized = false;
                ...
                {
                    _smp.message_pool.getInstance().push(new message($"[GameServer::requestLogin][Warning] PLAYER[UID={session.m_pi.uid}]. GKey invalid or reused.", type_msg.CL_FILE_LOG_AND_CONSOLE));
                    session.m_is_authorized = false;
                    SendLoginAck(session, eLoginAck.ACK_SECURITY_KEY);
                    return;
                }
        ...
        private void ReadLoginPacket(Player session, packet pkt,
            ...
            out uint outPacketVersion, out uint outIsPcBang, out string outGKey, out bool outHasGKey)
        {
        ...
        private bool ValidateLoginPacket(Player session,
            ...
            bool hasAuthKeyLogin, string lkey,
        ...
        private void CheckAccountBlock(Player session)
        {
            var s = session.m_pi;
            if (s.block_flag.m_id_state.ull_IDState == 0) return;

            if (s.block_flag.m_id_state.L_BLOCK_TEMPORARY && (s.block_flag.m_id_state.block_time == -1 || s.block_flag.m_id_state.block_time > 0))
            {
                throw new exception($"[GameServer::requestLogin][Error] Temporarily blocked. Time={(s.block_flag.m_id_state.block_time == -1 ? "indeterminate" : (s.block_flag.m_id_state.block_time / 60 + "min"))} Player UID={s.uid}");
            }

            if (s.block_flag.m_id_state.L_BLOCK_FOREVER)
                throw new exception($"[GameServer::requestLogin][Error] Permanently blocked player UID={s.uid}");

            if (s.block_flag.m_id_state.L_BLOCK_ALL_IP)
            {
                // add their IP to global block list
                snmdb.NormalManagerDB.getInstance().add(9, new CmdInsertBlockIp(session.getIP(), "255.255.255.255"), this.SQLDBResponse, this);
                throw new exception($"[GameServer::requestLogin][Error] PLAYER[UID={s.uid}, IP={session.getIP()}] Block ALL IP on login.");
            }
        }
            ...
            try
            {
                ...
                if (c != null)
                {
                    ...
                    if (m_ari.login == 2 || m_ari.login == 3) //sem o now
                    {
                        ...
                        if (reward_item == null)
                            throw new exception("[GameServer::requestEnterChannel][Error] nao conseguiu sortear um item para o player. Bug", ExceptionError.STDA_MAKE_ERROR_TYPE(STDA_ERROR_TYPE.ATTENDANCE_REWARD_SYSTEM, 7, 0));
        ...
        public void requestPrivateMessage(Player _session, packet _packet)
        {
            ...
            try
            {
                ...
                // Verifica se o m_chat_discod PCBangMascot está ativo para enviar o chat para o discord
        ...
        {
            var p = new PangyaBinaryWriter();
            TranslationSubPacket sub_packet_id = TranslationSubPacket.Request_Friend_List;
            try
            {
                sub_packet_id = (TranslationSubPacket)_packet.ReadUInt16();
                switch (sub_packet_id)
                {
                    case TranslationSubPacket.Request_Offline_Message:
                        {
                            ...
                            if (uid == 0)
                                throw new exception("[GameServer::requestTranslateSubPacket][ID=" + (sub_packet_id) + "][Error] PLAYER[UID=" + (_session.m_pi.uid) + "] tentou mandar Message Off["
                            ...
                            // Log
                            _smp.message_pool.getInstance().push(new message("[GameServer::requestTranslateSubPacket::MessageOff][Error] PLAYER[UID=" + (_session.m_pi.uid) + "] mandou Message Off["
                        ...
                        break;
                    case TranslationSubPacket.Request_Friend_List:
                        throw new exception("[GameServer::requestTranslateSubPacket][ID=" + (sub_packet_id) + "][Error] PLAYER[UID="
            ...
            {
                _smp.message_pool.getInstance().push(new message("[GameServer::requestTranslateSubPacket][ErrorSystem] " + e.getFullMessageError(), type_msg.CL_FILE_LOG_AND_CONSOLE));
        ...
        public void requestUCCWebKey(Player _session, packet _packet)
        {
            ...
            try
            {
                ...
                if (ctx_uwk.uid == 0)
                    throw new exception("[GameServer::requestUCCWebKey][Error] PLAYER[UID=" + (_session.m_pi.uid) + "] tentou gerar chave web de UCC[ITEM_ID="
                ...
                // Log
                _smp.message_pool.getInstance().push(new message("[UCC::SelfDesignSystem::GeraWebKey][Error] PLAYER[UID=" + (_session.m_pi.uid) + "] gerou Web Key[KEY=" + key + "] da UCC[TYPEID="
            ...
            {
                _smp.message_pool.getInstance().push(new message("[GameServer::requestUCCWebKey][ErrorSystem] " + e.getFullMessageError(), type_msg.CL_FILE_LOG_AND_CONSOLE));
        ...
        {
            if (job == null)
                throw new ArgumentException("[GameServer.MakeTime] job is invalid");


            var timer = m_timer_mgr.CreateTimer(milliseconds, job, autoRepeted);
            if (timer == null)
                throw new Exception("[GameServer.MakeTime] não conseguiu criar o timer");
        ...
        public void unMakeTime(PangyaSyncTimer timer)
        {
            if (timer == null)
            {
                throw new exception("[GameServer::unMakeTime][Error] Tentou deletar o timer, mas o argumento é null",
        ...
        public int getClientPacketVersion()
        {
            return (int)m_si.packet_version;
        }
