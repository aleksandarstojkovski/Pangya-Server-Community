                ...
                if (isSetItem(_ei.itens[i]._typeid))
                {
                    ...
                    if (!v_item.empty())
                    {
                        ...
                        foreach (var el in v_item)
                            _ei.itens.Add(new EmailInfo.item(-1, el._typeid, el.flag_time, (uint)el.qntd, (ushort)el.STDA_C_ITEM_TIME, 0, 0, 0/*PCBangMascot GM*/, 0, "", 0));
                    ...
                    case IFF_GROUP.CADDIE:
                        {
                            ...
                            {
                                ci.rent_flag = 2;
                                ci.end_date_unix = (ushort)_item.date_reserve; //(_item.PCBangMascot == 0x20) ? _item.STDA_C_ITEM_TIME : (_item.PCBangMascot == 0x40) ? _item.STDA_C_ITEM_TIME * 60 * 60 : _item.STDA_C_ITEM_TIME;
                            }
                    ...
                    case IFF_GROUP.CADDIE:
                        {
                            ...
                            {
                                ci.rent_flag = 2;
                                ci.end_date_unix = _item.date_reserve; //(_item.PCBangMascot == 0x20) ? _item.STDA_C_ITEM_TIME : (_item.PCBangMascot == 0x40) ? _item.STDA_C_ITEM_TIME * 60 * 60 : _item.STDA_C_ITEM_TIME;
                            }
