    ...
    public class RoomManager
    {
        ...
        private void ValidateVsApproach(Player session, RoomInfoEx ri, ChannelInfo m_ci)
        {
            ...
            else if (ri.qntd_hole == 18)
            {
                ...
                ThrowHackException(session, ri, m_ci, "HoleNum inválido para VS/Approach");
            ...
            if (!allowedPlayers.Contains(ri.max_player) && !session.m_pi.m_cap.game_master)
                ThrowHackException(session, ri, m_ci, "UserLimit inválido no VS/Approach");

            // Canal normal não permite Modo aleatório (random) — apenas Modo == 3 é permitido para "random"
            if (m_ci != null && m_ci.flag.all && ri.modo != 3)
        ...
        // --------- ValidateRoomName (mantive seu comportamento, apenas garanto mensagens coerentes) ----------
        ...
        // --------- ValidateRoomPass (mantive lógica sua) ----------
        ...
        // --------- ValidateRoomCreate (mantive sua lista; nenhum change) ----------
        ...
        // --------- ThrowHackException (mantive sua mensagem e tipo, adapte se necessário) ----------
