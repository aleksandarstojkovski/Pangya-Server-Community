...
namespace Pangya_GameServer.Game.GameModes
{
    public class PangBattle : VersusBase
    {
        ...
        public override void sendPlayerTurn()
        {
            ...
            p.WriteByte(0); // Flag do vento, 1 Reseta o Vento, 0 soma o vento que nem o comando gm \wind do pangya original, , Tamb m   PCBangMascot para trocar o vento no Pang Battle se mandar o valor 0
