...
namespace Pangya_GameServer.PacketFunc
{
    ...
    public class packet_func : packet_func_base
    {
        public static int packet_svFazNada(object param, ParamDispatch pd)
        {
            ...
            _smp.message_pool.getInstance().push(new message("Packet ID: " + ((PacketIDServer)pd._packet.Id) + " has send.", type_msg.CL_ONLY_FILE_LOG));
            return 0;
        }
        ...
        public static int principal(ref PangyaBinaryWriter p, PlayerInfo pi, ServerInfoEx _si)
        {
            try
            {
                ...
                if (_si.version_client.Length > 6)
                    throw new exception("Erro _si.version_client.Length > 6. packet_func::principal()");

                if (_si.version.Length > 17)
                    throw new exception("Erro _si.version.Length > 17. packet_func::principal()");

                p.WritePStr(_si.version_client);//max size 6+2=8size
                p.WritePStr(_si.version);//max size 17+2=19size
                //write struct member info player      
                p.WriteBytes(pi.getLoginInfo());//new version-> 263 bytes
                p.WriteUInt32(pi.uid);
                // write struct user info player(statistic)
                p.WriteBytes(pi.UserInfo());//new version-> 239 bytes 
                // write struct Trofel Info
                p.WriteBytes(pi.getInfoTrophy());//new version-> 78 bytes
                //write struct User Equip
                p.WriteBytes(pi.UserEquip());//new version-> 116 bytes
                //write struct map statistic
                p.WriteBytes(pi.GetMapStatistic());//new version-> 10836 bytes    
                //Write struct Equiped Items
                p.WriteBytes(pi.UserEquipedItem());//new version-> 628 bytes
                // Write Time, 16 Bytes
                p.WriteTime();
                ...
                p.WriteBytes(pi.mi.papel_shop.ToArray());//6 bytes  
                ...
                p.WriteZero(277);//guild talvez
                return 0; //total is 12512 +(44, 00, 00) = 12515 bytes 
            }
            catch (exception e)
            {
        ...
        public static int packet1EB(object _arg1, ParamDispatch pd)
        {

            try
            {

                var c = sgs.gs.getInstance().findChannel(getPlayer(pd._session).m_pi.channel);

                if (c != null)
                    c.requestOpenScratchCard(getPlayer(pd._session), pd._packet);
        ...
        public static int packet00DD(object _arg1, ParamDispatch pd)
        {
            ...
            try
            {
                ...
                if (c != null)
                    c.requestPlayScratchCard(getPlayer(pd._session), pd._packet);
        ...
        public static int packet00DE(object _arg1, ParamDispatch pd)
        {
            ...
            try
            {
                ...
                if (c != null)
                    c.requestPlayScratchCardSerial(getPlayer(pd._session), pd._packet);
        ...
        public static int packet0050(object _arg1, ParamDispatch pd)
        {
            ...
            try
            {
                ...
                if (c != null)
                    c.requestChangeNickName(getPlayer(pd._session), pd._packet);

            }
            catch (exception e)
            {

                _smp.message_pool.getInstance().push(new message("[packet_func::packet_sv050][ErrorSystem] " + e.getFullMessageError(), type_msg.CL_FILE_LOG_AND_CONSOLE));
        ...
        public static int packet0108(object _arg1, ParamDispatch pd)
        {


            try
            {
                //sGuildSystem.getInstance().requestGuildList(getPlayer(pd._session)), pd._packet);
            }
            catch (exception e)
            {

                _smp.message_pool.getInstance().push(new message("[packet_func::packet_sv4D][ErrorSystem] " + e.getFullMessageError(), type_msg.CL_FILE_LOG_AND_CONSOLE));
            }

            return 0;
        }

        public static int packet0109(object _arg1, ParamDispatch pd)
        {


            try
            {
                //sGuildSystem.getInstance().requestGuildSearch(getPlayer(pd._session)), pd._packet);
            }
            catch (exception e)
            {
        ...
        public static int packet010A(object _arg1, ParamDispatch pd)
        {


            try
            {
                //sGuildSystem.getInstance().requestGuildLog(getPlayer(pd._session)), pd._packet);
            }
            catch (exception e)
            {
        ...
        public static int packet0104(object _arg1, ParamDispatch pd)
        {


            try
            {
                //sGuildSystem.getInstance().requestGuildData(getPlayer(pd._session)), pd._packet);
            }
            catch (exception e)
            {
        ...
        public static int packet0112(object _arg1, ParamDispatch pd)
        {


            try
            {
                //sGuildSystem.getInstance().requestGuildPlayer(getPlayer(pd._session)), pd._packet);
            }
            catch (exception e)
            {

                _smp.message_pool.getInstance().push(new message("[packet_func::requestGuildPlayer][ErrorSystem] " + e.getFullMessageError(), type_msg.CL_FILE_LOG_AND_CONSOLE));
            }

            return 0;
        }

        public static int packet0110(object _arg1, ParamDispatch pd)
        {


            try
            {
                //sGuildSystem.getInstance().requestGuildPromote(getPlayer(pd._session)), pd._packet);
            }
            catch (exception e)
            {

                _smp.message_pool.getInstance().push(new message("[packet_func::requestCallGuilPromote][ErrorSystem] " + e.getFullMessageError(), type_msg.CL_FILE_LOG_AND_CONSOLE));
            }

            return 0;
        }

        public static int packet0111(object _arg1, ParamDispatch pd)
        {


            try
            {
                //sGuildSystem.getInstance().requestGuildNoticeSetPlayer(getPlayer(pd._session)), pd._packet);
            }
            catch (exception e)
            {

                _smp.message_pool.getInstance().push(new message("[packet_func::requestGuildNoticeSetPlayer][ErrorSystem] " + e.getFullMessageError(), type_msg.CL_FILE_LOG_AND_CONSOLE));
            }

            return 0;
        }

        public static int packet0102(object _arg1, ParamDispatch pd)
        {


            try
            {
                //sGuildSystem.getInstance().requestCheckGuildName(getPlayer(pd._session)), pd._packet);
            }
            catch (exception e)
            {

                _smp.message_pool.getInstance().push(new message("[packet_func::requestGuildCheckName][ErrorSystem] " + e.getFullMessageError(), type_msg.CL_FILE_LOG_AND_CONSOLE));
            }

            return 0;
        }

        public static int packet0103(object _arg1, ParamDispatch pd)
        {


            try
            {
                //sGuildSystem.getInstance().requestChangeGuildName(getPlayer(pd._session)), pd._packet);
            }
            catch (exception e)
            {

                _smp.message_pool.getInstance().push(new message("[packet_func::requestChangeGuildName][ErrorSystem] " + e.getFullMessageError(), type_msg.CL_FILE_LOG_AND_CONSOLE));
            }

            return 0;
        }

        public static int packet0101(object _arg1, ParamDispatch pd)
        {
            ...
            try
            {
                //sGuildSystem.getInstance().requestGuildMake(getPlayer(pd._session)), pd._packet);
            }
            catch (exception e)
            {

                _smp.message_pool.getInstance().push(new message("[packet_func::requestGuildCreate][ErrorSystem] " + e.getFullMessageError(), type_msg.CL_FILE_LOG_AND_CONSOLE));
            }

            return 0;
        }

        public static int packet00C5(object _arg1, ParamDispatch pd)
        {
        ...
        public static int packet010C(object _arg1, ParamDispatch pd)
        {
            ...
            try
            {
                //sGuildSystem.getInstance().requestGuildJoin(getPlayer(pd._session)), pd._packet);
            }
            catch (exception e)
            {

                _smp.message_pool.getInstance().push(new message("[packet_func::requestGuildJoin][ErrorSystem] " + e.getFullMessageError(), type_msg.CL_FILE_LOG_AND_CONSOLE));
            }

            return 0;
        }

        public static int packet0116(object _arg1, ParamDispatch pd)
        {


            try
            {
                //sGuildSystem.getInstance().requestGuildAfterUploadMark(getPlayer(pd._session)), pd._packet);
            }
            catch (exception e)
            {

                _smp.message_pool.getInstance().push(new message("[packet_func::requestGuildCallAfterUpload][ErrorSystem] " + e.getFullMessageError(), type_msg.CL_FILE_LOG_AND_CONSOLE));
            }

            return 0;
        }

        public static int packet010E(object _arg1, ParamDispatch pd)
        {


            try
            {
                //sGuildSystem.getInstance().requestGuildAccept(getPlayer(pd._session)), pd._packet);
            }
            catch (exception e)
            {

                _smp.message_pool.getInstance().push(new message("[packet_func::requestGuildAccept][ErrorSystem] " + e.getFullMessageError(), type_msg.CL_FILE_LOG_AND_CONSOLE));
            }

            return 0;
        }

        public static int packet0114(object _arg1, ParamDispatch pd)
        {


            try
            {
                //sGuildSystem.getInstance().requestGuildKick(getPlayer(pd._session)), pd._packet);
            }
            catch (exception e)
            {

                _smp.message_pool.getInstance().push(new message("[packet_func::requestGuildCallKick][ErrorSystem] " + e.getFullMessageError(), type_msg.CL_FILE_LOG_AND_CONSOLE));
            }

            return 0;
        }

        public static int packet0115(object _arg1, ParamDispatch pd)
        {


            try
            {
                //sGuildSystem.getInstance().requestGuildUploadMark(getPlayer(pd._session)), pd._packet);
            }
            catch (exception e)
            {

                _smp.message_pool.getInstance().push(new message("[packet_func::requestGuildCallUpload][ErrorSystem] " + e.getFullMessageError(), type_msg.CL_FILE_LOG_AND_CONSOLE));
            }

            return 0;
        }

        public static int packet010D(object _arg1, ParamDispatch pd)
        {


            try
            {
                //sGuildSystem.getInstance().requestGuildCancelJoin(getPlayer(pd._session)), pd._packet);
            }
            catch (exception e)
            {

                _smp.message_pool.getInstance().push(new message("[packet_func::requestCallGuilCancelJoinGuild][ErrorSystem] " + e.getFullMessageError(), type_msg.CL_FILE_LOG_AND_CONSOLE));
            }

            return 0;
        }

        public static int packet0105(object _arg1, ParamDispatch pd)
        {


            try
            {
                //sGuildSystem.getInstance().requestGuildChangeNotice(getPlayer(pd._session)), pd._packet);
            }
            catch (exception e)
            {

                _smp.message_pool.getInstance().push(new message("[packet_func::requestGuildChangeNotice][ErrorSystem] " + e.getFullMessageError(), type_msg.CL_FILE_LOG_AND_CONSOLE));
            }

            return 0;
        }

        public static int packet0106(object _arg1, ParamDispatch pd)
        {


            try
            {
                //sGuildSystem.getInstance().requestGuildChangeIntro(getPlayer(pd._session)), pd._packet);
            }
            catch (exception e)
            {

                _smp.message_pool.getInstance().push(new message("[packet_func::requestGuildChangeIntro][ErrorSystem] " + e.getFullMessageError(), type_msg.CL_FILE_LOG_AND_CONSOLE));
            }
        ...
        public static byte[] pacote157(MemberInfoEx _mi, byte season)
        {
            ...
            p.WriteByte(season);  
            _mi.state_flag.visible = false;
            _mi.state_flag.whisper =true;
            _mi.state_flag.channel = true;
        ...
        public static byte[] pacote071(CaddieManager v_element, int option = 0)
        {
            ...
            try
            {
                ...
                p.WriteInt16((short)v_element.Count);
                foreach (var caddie_info in v_element.Values)
                {
                    p.WriteBytes(caddie_info.getInfo().ToArray());
                }
                return p.GetBytes;
            }
            catch (Exception)
...
int option = 0)
        ...
        public static bool pacote048(ref PangyaBinaryWriter p, Player _session, List<PlayerRoomInfoEx> v_element, int option = 0)
        {
            ...
            try
            {
                ...
                {
                    int elementSize = (option & 0x100) != 0 ? PlayerRoomInfo.SIZE_STRUCT : PlayerRoomInfoEx.SIZE_STRUCT_EX;
                    int maxPacket = PlayerRoomInfoEx.SIZE_STRUCT_EX;
                    ...
                    while (index < total)
                    {
                        ...
                        for (int i = 0; i < por_packet && index < total; i++, index++)
                        {
                            ...
                            if (elementSize == PlayerRoomInfoEx.SIZE_STRUCT)
                            {
                    ...
                    try
                    {
                        if (totalSize < MAX_BUFFER_PACKET - 100)//-> MAKE_END_SPLIT_PACKET nao tem, so no else, OK?
                        {
                            ...
                            foreach (var playerRoom in v_element)
                            {
                                ...
                                if (elementSize == PlayerRoomInfo.SIZE_STRUCT)
                                {
                                    p.WriteBytes(playerRoom.ToArray());
                                }
                                else
                        ...
                        else
                        {
                            ...
                            while (index < total)
                            {
                                ...
                                {
                                    elementSize = PlayerRoomInfoEx.SIZE_STRUCT;
                                    p.WriteInt32(_session.m_oid);
                                }
