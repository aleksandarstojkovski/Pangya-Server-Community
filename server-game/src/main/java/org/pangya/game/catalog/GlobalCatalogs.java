...
public final class GlobalCatalogs {
    ...
    private void reloadIffSqlStandIns() {
        ...
        if (pangyaIffPath != null) {
            log.info("auth reload IFF (Course/Part/Item/Card/Character/CharacterMastery/Enchant/ClubSet/Caddie/Mascot/ClubSetWorkShop/Cutin/TimeLimit/CadieMagicBox from {})", pangyaIffPath);
        } else {
