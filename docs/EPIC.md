...
| Campo | Valore |
|-------|--------|
| Fatto | card-pack `0xCA`: SQL ordered draw, consume pack + add cards + variable C# `0x154` rows |
| Prossimo opcode/file C# | daily `0x152`, UCC `0xB9`, memorial `0x17F`, o GZ `packet137` pulse |
...
| **S4** | Tutte le modalità C# + manager char/card/caddie/achievement | **non done** — Channel 197; ~158 success 1:1 / 14 fail-stub; IFF cubes/combo aperti |
