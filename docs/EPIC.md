...
| Campo | Valore |
|-------|--------|
| Fatto | Take-mail `0x146` ITEM: `0x216` type-2 UCC 15 byte + `pacote214(0)`; Rookie mail Pang Mastery ×3 |
| Prossimo opcode/file C# | GZ first-hole `packet137` pulse, o fail-stub IFF-free (locker add PART, daily `0x152`) |
...
| **S4** | Tutte le modalità C# + manager char/card/caddie/achievement | **non done** — Channel 197; ~135 success 1:1 / 37 fail-stub; IFF cubes/cutin/combo aperti |
