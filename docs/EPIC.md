...
| Campo | Valore |
|-------|--------|
| Fatto | GP enter `0x179`: SQL GrandPrixData + create/reuse tipo 20 room + normal C# room dump |
| Prossimo opcode/file C# | daily `0x152`, UCC `0xB9`, Tiki, lucky-pouch, o GZ `packet137` pulse |
...
| **S4** | Tutte le modalità C# + manager char/card/caddie/achievement | **non done** — Channel 197; ~161 success 1:1 / 11 fail-stub; IFF cubes/combo aperti |
