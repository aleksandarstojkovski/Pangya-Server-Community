...
| Campo | Valore |
|-------|--------|
| Fatto | delete-item `0x64` ITEM SQL: `0xC5` u8 1 + typeid + qntd + id; non-ITEM resta sbyte -1 |
| Prossimo opcode/file C# | GZ first-hole `packet137` pulse, o fail-stub IFF-free (daily `0x152`, workshop) |
...
| **S4** | Tutte le modalità C# + manager char/card/caddie/achievement | **non done** — Channel 197; ~138 success 1:1 / 34 fail-stub; IFF cubes/cutin/combo aperti |
