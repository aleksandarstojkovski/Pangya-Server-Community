...
| Campo | Valore |
|-------|--------|
| Fatto | new Tiki `0x18D`: consume + mileage rollover + Pang + `0xC8`/`0x216`/`0x274`, no-bonus path |
| Prossimo opcode/file C# | daily `0x152`, UCC `0xB9`, lucky-pouch, o GZ `packet137` pulse |
...
| **S4** | Tutte le modalità C# + manager char/card/caddie/achievement | **non done** — Channel 197; ~164 success 1:1 / 8 fail-stub; IFF cubes/combo aperti |
