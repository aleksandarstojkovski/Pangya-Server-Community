...
| Campo | Valore |
|-------|--------|
| Fatto | Tutorial `0xAE` → `0x11F` u8 tipo + u8 1 + u32 flags; mail Rookie; SQL `pangya.tutorial` |
| Prossimo opcode/file C# | GZ first-hole `packet137` pulse, o fail-stub IFF-free (locker add PART, take-mail, daily `0x152`) |
...
| **S4** | Tutte le modalità C# + manager char/card/caddie/achievement | **non done** — Channel 197; ~134 success 1:1 / 38 fail-stub; IFF cubes/cutin/combo aperti |
