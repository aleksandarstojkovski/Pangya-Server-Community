...
| Campo | Valore |
|-------|--------|
| Fatto | memorial `0x17F`: SQL ordered rewards, add + consume coin + `0x216` + `0x264` |
...
| **S4** | Tutte le modalità C# + manager char/card/caddie/achievement | **non done** — Channel 197; ~159 success 1:1 / 13 fail-stub; IFF cubes/combo aperti |
