...
| Campo | Valore |
|-------|--------|
| Fatto | legacy Tiki `0x128`/`0x129`: item↔TP SQL, `0x216` + `0x1E9`/`0x1EA`; `0x127` persisted points |
| Prossimo opcode/file C# | daily `0x152`, UCC `0xB9`, Tiki `0x18D`, lucky-pouch, o GZ `packet137` pulse |
...
| **S4** | Tutte le modalità C# + manager char/card/caddie/achievement | **non done** — Channel 197; ~163 success 1:1 / 9 fail-stub; IFF cubes/combo aperti |
