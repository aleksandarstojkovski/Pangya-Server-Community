...
| Campo | Valore |
|-------|--------|
| Slice completata | **S0–S6** packet paths: shop SQL catalog `0xAA`/`0x68` success, messenger `0x102` pages, lounge `0x196`, GZ/SSC start-game |
