...
| Campo | Valore |
|-------|--------|
| Fatto | ticket scroll `0xAB`: C1/C2 id check + SQL report date + delete + `0x11A` count 0/SYSTEMTIME |
| Prossimo opcode/file C# | daily `0x152`, UCC `0xB9`, Tiki, GP enter, o GZ `packet137` pulse |
...
| **S4** | Tutte le modalità C# + manager char/card/caddie/achievement | **non done** — Channel 197; ~160 success 1:1 / 12 fail-stub; IFF cubes/combo aperti |
