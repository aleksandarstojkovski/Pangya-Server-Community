...
| Campo | Valore |
|-------|--------|
| Fatto | UCC web-key `0xC9`: online owner/item validation + generated key + `0x153` success |
| Prossimo opcode/file C# | UCC `0xB9`, lucky-pouch, o GZ `packet137` |
...
| **S4** | Tutte le modalità C# + manager char/card/caddie/achievement | **non done** — Channel 197; ~170 success 1:1 / 2 fail-stub; IFF cubes/combo aperti |
