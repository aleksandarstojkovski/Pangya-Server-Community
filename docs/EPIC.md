...
| Campo | Valore |
|-------|--------|
| Fatto | Dolfini locker add `0xCE` / remove `0xCF` PART SQL: `0x139`+`0xEC`+`0x16E` / `0xEC`+`0x16F` |
| Prossimo opcode/file C# | GZ first-hole `packet137` pulse, o fail-stub IFF-free (daily `0x152`, delete-item `0x64`) |
...
| **S4** | Tutte le modalità C# + manager char/card/caddie/achievement | **non done** — Channel 197; ~137 success 1:1 / 35 fail-stub; IFF cubes/cutin/combo aperti |
