...
S4 profondità: **160** opcode success 1:1 / **12** opcode solo fail-stub / **13** stimati rimanenti dal C# Channel
...
Fatto: ticket-report scroll `0xAB` (`requestOpenTicketReportScroll`). SQL `ticket_report_catalog` (V30, **196** tabelle) sostituisce `CmdTicketReportDadosInfo` header; valida warehouse id e ticket id codificato C1/C2, invalida lo scroll e manda `0x11A` u32 player-count 0 + SYSTEMTIME. Ogni fail resta i32 -1 + 16 zero.
Prossimo opcode/file C#: daily `0x152`–`0x154`; UCC `0xB9`; Tiki success `0x128`/`0x129`/`0x18D`; GZ first-hole `packet137` pulse; GP enter `0x179`; lucky-pouch `0xB2`.
...
- Parità client reale: ~160/197 Channel con happy-path; SQL al posto IFF; fail-stub su UCC/daily/Tiki/GP/lucky-pouch; zero capture JP S9.
