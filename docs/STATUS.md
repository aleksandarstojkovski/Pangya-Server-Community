...
S4 profondità: **161** opcode success 1:1 / **11** opcode solo fail-stub / **12** stimati rimanenti dal C# Channel
...
Fatto: GP enter `0x179` (`requestEnterRoomGrandPrix`). SQL `grand_prix_event` (V31, **197** tabelle) sostituisce GrandPrixData IFF attivo senza restrizioni opzionali; valida evento/livello, crea o riusa room tipo 20 max 30 con course/holes/mode/natural/rule, poi invia il normale dump room C#. Errori `0x253` CHANNEL `shopSys`; else full `0x6700000`.
Prossimo opcode/file C#: daily `0x152`–`0x154`; UCC `0xB9`; Tiki success `0x128`/`0x129`/`0x18D`; GZ first-hole `packet137` pulse; lucky-pouch `0xB2`.
...
- Parità client reale: ~161/197 Channel con happy-path; SQL al posto IFF; fail-stub su UCC/daily/Tiki/lucky-pouch; zero capture JP S9.
