...
S4 profondità: **167** opcode success 1:1 / **5** opcode solo fail-stub / **6** stimati rimanenti dal C# Channel
...
Fatto: daily accept/reward/leave `0x152`–`0x154`. V34 `iff_daily_quest_stuff`/`reward` (**200** tabelle); accept crea counter item, status 3, data e manda `0x216` + full `0x226`; leave rimuove achievement/quest/counter e manda `0x216` + `0x228`; reward aggiunge item IFF, rimuove quest/counter e manda `0x216` + `0x227`. Zero/malformed conserva fail C#.
Prossimo opcode/file C#: UCC `0xB9`/`0xC9`; GZ first-hole `packet137` pulse; lucky-pouch `0xB2`; intrusion `0x9D`; achievement GUI `0x157`.
...
- Parità client reale: ~167/197 Channel con happy-path; SQL al posto IFF; fail-stub su UCC/lucky-pouch/intrusion/achievement GUI; zero capture JP S9.
